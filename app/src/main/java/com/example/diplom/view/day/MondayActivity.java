...
public class MondayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new Adapter(this, MondayActivity.this, notesList); // инициализация адаптера и передача в него данных из БД
        ...
        fabAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(MondayActivity.this, AddLessonActivity.class));
            }
        });
        ...
        fabDel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(MondayActivity.this, MondayActivity.class));
                Toast.makeText(MondayActivity.this, "Данные из блокнота удалены", Toast.LENGTH_SHORT).show();
            }
        });
    }
    // метод считывания из БД всех записей
    public void fetchMondayLesson(){
