...
public class SaturdayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new Adapter(this, SaturdayActivity.this, notesList); // инициализация адаптера и передача в него данных из БД
        ...
        fabAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(SaturdayActivity.this, AddLessonActivity.class));
            }
        });
        ...
        fabDel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(SaturdayActivity.this, SaturdayActivity.class));
                Toast.makeText(SaturdayActivity.this, "Данные из блокнота удалены", Toast.LENGTH_SHORT).show();
            }
        });
    }
    // метод считывания из БД всех записей
    public void fetchSaturdayLesson(){
