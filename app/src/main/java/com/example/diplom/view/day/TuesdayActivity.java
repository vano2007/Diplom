...
public class TuesdayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new Adapter(this, TuesdayActivity.this, notesList); // инициализация адаптера и передача в него данных из БД
        ...
        fabAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(TuesdayActivity.this, AddLessonActivity.class));
            }
        });
        ...
        fabDel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(TuesdayActivity.this, TuesdayActivity.class));
                Toast.makeText(TuesdayActivity.this, "Данные из блокнота удалены", Toast.LENGTH_SHORT).show();
            }
        });
    }
    // метод считывания из БД всех записей
    public void fetchTuesdayLesson(){
